...
function About() {
  return (
    <div className='col-11 mx-auto text-dark d-lg-flex align-items-center justify-content-center' style={{height:'100vh'}}>
        <div className='col-lg-5 col-11 mx-auto'>

        <img  className="rounded w-100" src="https://th.bing.com/th/id/OIP.OvVqdIHXyvm-q3TFc-19NwHaFe?w=244&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7" alt="" />
        </div>

        <div className='col-lg-6 col-11 mx-auto'>
            <h1>About Genero'23</h1>
