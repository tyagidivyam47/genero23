        ...
        <nav className="px-3 navbar navbar-expand-lg navbar-light ">
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltarkup">
                <div className="navbar-nav align-items-center" >
                    ...
                    <Link className="nav-item nav-link text-light" to="/home?loaded=true=query=history">PAST</Link>
                    <Link className="nav-item nav-link text-light" to="/home?loaded=true=query=theme">THEME</Link>
